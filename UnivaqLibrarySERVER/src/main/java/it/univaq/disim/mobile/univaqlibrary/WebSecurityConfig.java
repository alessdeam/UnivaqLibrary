...
import it.univaq.disim.mobile.univaqlibrary.common.spring.security.JWTAuthenticationEntryPoint;
import it.univaq.disim.mobile.univaqlibrary.common.spring.security.JWTAuthenticationTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
				...
				.antMatchers("/api/biblioteche/**", "/api/libri/**").authenticated()
